...
date: 2026-08-21 10:00:0 +0000
categories: [Programming, Bash]
tags: [Bash, Programming]
pin: false
mermaid: true
---
# Bash — Personal Reference Guide

Notes to review Bash concepts, syntax, and short examples — a place to come back to whenever I forget how something works. No need to memorize every command; the point is quick lookup.
